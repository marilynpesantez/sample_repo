...
-- 0B. Load 2009-2010 data into sales table
LOAD DATA LOCAL INFILE '/Users/marilynpesantez/Downloads/Kaggle/online_retail_IIA.csv'
INTO TABLE sales
FIELDS TERMINATED BY ','
IGNORE 1 LINES;

-- 0C. Load 2010-2011 data into sales table
LOAD DATA LOCAL INFILE '/Users/marilynpesantez/Downloads/Kaggle/online_retail_IIB.csv'
INTO TABLE sales
FIELDS TERMINATED BY ','
IGNORE 1 LINES;
------------------------------------------------------------------------------------------------------------------------------------------------
...
-- These will be excluded from the sales view used for analysis
------------------------------------------------------------------------------------------------------------------------------------------------
...
SELECT
    ...
    SUM(CASE WHEN Item = '' OR Item = ' ' THEN 1 ELSE 0 END) AS Description_empty_string_count,
...
FROM sales;
-- Result: 4,382 in Description column, 6,202 in UnitPrice column, and 243,007 in CustomerID column
------------------------------------------------------------------------------------------------------------------------------------------------
